...
const Tour: React.FC<TourProps> = ({
  ...
  }, [currentStep, currentTourSteps, isInView, offset, isTourVisible]);
  ...
  }, [currentStep, currentTourSteps, isTourVisible]);
  ...
  return (
    <div data-name="Tour-wrapper" className="relative w-full" data-tour="dev">
      ...
      {pointerPosition && isTourVisible && CardComponent && (
        <Portal>
          ...
          <motion.div
            ...
            initial="hidden"
            animate={isTourVisible ? "visible" : "hidden"}
            variants={variants}
